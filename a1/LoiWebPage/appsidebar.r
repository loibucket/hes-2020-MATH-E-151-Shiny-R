...
#The user interface
header <- dashboardHeader(title = "Loi and Shiny")
...
body <- dashboardBody(fluidRow(stylesheet,
                               ...
                               tabItems(
                                 ...
                                 tabItem(tabName = "Hobbies",
                                         fluidRow(
                                           ...
                                           withTags(table(
                                             tr(th("Links")),
                                             tr(td(a(href = "https://github.com/loibucket","Github"))),
                                             tr(td(a(href = "https://www.linkedin.com/in/loicheng/","LinkedIn"))),
                                             tr(td(a(href = "https://loiapps.herokuapp.com/","Heroku"))),
                                             tr(td(a(href = "https://www.youtube.com/channel/UCZY46Q2pIjQhE26B7nJ3x2Q/","YouTube"))),
                                           )),   
                                           
                                           h3("Video"),
                                           h3(
                                             tags$iframe(width="320",height="180", src="https://www.youtube.com/embed/f0dU5-QMWaQ", frameborder="0", allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture", allowfullscreen=NA)
                                             )
                                         )
                                         )
                               )))
